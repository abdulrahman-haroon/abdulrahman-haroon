...
# Hey there, I'm Abdul Rahman Haroon 👋
...
```yaml
name: Abdul Rahman Haroon
location: Dublin, Ireland 🇮🇪
education:
  - MSc Cyber Security @ National College of Ireland (2026-2027)
  - BSc Software Engineering @ CUST — Gold Medalist (3.97/4.0 CGPA)
current_focus: Secure Software Development & Application Security
fun_fact: Built a bug tracker using NLP that reduced bug duplication by 98%
```

- 🔭 **4+ years** of professional experience building **scalable web & mobile applications**
- 🚀 Led development of **Umraat.com** — helped generate **$1.1M revenue** in 5 months
- 🏗️ Architected platforms handling **50,000+ daily requests** and **50+ concurrent bids**
- 🔐 Currently deepening expertise in **Cyber Security**, Penetration Testing & Secure Programming
- 🏆 **IEEE Competition Winner** — 1st in Programming, 2nd in Mobile App Development
...
### Security & Monitoring
![CyberArk](https://img.shields.io/badge/CyberArk-00B4E6?style=for-the-badge&logoColor=white)
...
|--------|---------|------|------------|
| **2022 – 2026** | **Golden Time Travel & Tourism** 🇸🇦 | Application Programmer | Led **umraat.com** ($1.1M rev), **bedbank.sa**, **soomy.sa** auction platform, Flutter mobile apps |
| **2022 – 2026** | **Uniti Solutions** 🇺🇸 | Software Developer | SD-WAN portals, microservices, 30% faster data retrieval, 99.9% uptime |
| **2023 – 2024** | **Alpha Next ITech** 🇸🇦 | Lead Developer | ERP systems for 2,000+ employees, resolved 50+ critical bugs |
| **2019 – 2022** | **Nayel Solutions** 🇵🇰 | Software Engineer | University platform (15K+ students), OTA microservice migration |
| **2021 – 2022** | **Lycore** 🇸🇦 | Software Engineer | CMS on AWS, Auth system for 100K+ accounts |
